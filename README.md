...
- Update the following environment variables:
  - `ADMIN_IDS`: a comma seperated list of the user IDs of your bot administrators
  - `CLIENT_ID`: your bot's token in Discord
  - `FIMFIC_BEARER_TOKEN`: the bearer token used to interact with Fimfic's APIs
  - `MAIN_CHAT`: the name of the chat channel considered the main one in your server
